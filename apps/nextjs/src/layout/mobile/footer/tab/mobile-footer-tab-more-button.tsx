...
import { MobileFooterMoreDrawer, MobileFooterMoreTabs } from "./more-drawer/mobile-footer-more-drawer";
...
export const MobileFooterTabMoreButton = ({ activeTab, disclosure }: MobileFooterTabMoreButtonProps) => {
  ...
  return (
    <>
      ...
      <MobileFooterMoreDrawer opened={drawerOpened} closeDrawer={drawer.close} activeTab={activeTab} />
    </>
  );
};
